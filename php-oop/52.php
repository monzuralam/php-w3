...
if( ( 'update' == ( isset( $_GET['action'] ) ) ?? $_GET['action'] ) && isset( $_GET['id'] ) ){
    ...
    <div class="row">
        <div class="col-4">
            ...
            <?php
                ...
                if( ( 'delete' == ( isset( $_GET['action'] ) ) ?? $_GET['action'] ) && isset( $_GET['id'] ) ){
                    $id = ( isset( $_GET['id'] ) ) ? $_GET['id'] : null;
                        ...
                        <?php
                            foreach( Query::ReadAll() as $key => $value ){
                                ...
                                <tr>
                                    ...
                                    <td><a href="52.php?action=update&id=<?php echo $value["id"]; ?>">Edit</a> | <a href="52.php?action=delete&id=<?php echo $value["id"]; ?>" onclick="confirm('Are you sure?')">Delete</a></td>
                                </tr>
                                <?php
                            }
                        ?>
